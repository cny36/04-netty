...
public class NettyClientHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ProtobufMessager protobufMessager = new ProtobufMessager("hello, netty server", new Date());
//        byte[] serializer = ProtobufUtils.serializer(protobufMessager);
//        ByteBuf byteBuf = Unpooled.copiedBuffer(serializer);
//        ctx.writeAndFlush(byteBuf);
        ctx.writeAndFlush(protobufMessager);
    }
